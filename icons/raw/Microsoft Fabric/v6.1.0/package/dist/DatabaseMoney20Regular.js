...
var SvgDatabaseMoney20Regular = function SvgDatabaseMoney20Regular(_a, ref) {
  var title = _a.title,
    titleId = _a.titleId,
  ...
  return /*#__PURE__*/React.createElement("svg", __assign({
    ...
    d: "M4 5c0-1.007.875-1.755 1.904-2.222C6.978 2.289 8.427 2 10 2s3.022.29 4.096.778C15.125 3.245 16 3.993 16 5v6h-1V6.7a5 5 0 0 1-.904.524C13.022 7.712 11.573 8 10 8s-3.022-.288-4.096-.777A5 5 0 0 1 5 6.7V15c0 .373.356.875 1.318 1.312.702.319 1.629.553 2.682.645V17c0 .355.093.688.255.978-1.282-.076-2.449-.345-3.351-.756C4.875 16.756 4 16.008 4 15.001zm1 0c0 .374.356.876 1.318 1.313C7.234 6.73 8.536 7 10 7s2.766-.27 3.682-.687C14.644 5.876 15 5.374 15 5c0-.373-.356-.875-1.318-1.312C12.766 3.27 11.464 3 10 3s-2.766.271-3.682.688C5.356 4.125 5 4.627 5 5"
...
var ForwardRef = /*#__PURE__*/forwardRef(SvgDatabaseMoney20Regular);
